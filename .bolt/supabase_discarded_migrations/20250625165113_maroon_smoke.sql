/*
  # Optimize Realtime for Photo Deletions
  
  1. Changes
    - Ensure all tables are properly added to the realtime publication
    - Add explicit DELETE event support to the realtime publication
    - Optimize database triggers for better realtime performance
    
  2. Benefits
    - Improves reliability of realtime DELETE notifications
    - Ensures consistent behavior across all clients
    - Reduces latency for realtime updates
*/
