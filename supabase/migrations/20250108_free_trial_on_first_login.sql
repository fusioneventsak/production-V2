-- Free trial on first login: 14 days
...
-- This approach avoids signup 500 errors by deferring database operations

create extension if not exists pgcrypto;

-- Function to initialize user profile and free trial on first login
-- Called from frontend AuthContext after successful authentication
...
-- Remove the old signup trigger to prevent 500 errors
